defmodule CleverElixirAlgorithms.StochasticAlgorithms.RandomSearch do
  def algorithm_2_2_1(%{ problem_size: problem_size, max_iter: mi, search_space: sample_space, cost: cost_fn }) do
    ...
    objective = CleverElixirAlgorithms.Utilities.get_objective_fn cost_fn, fn x, y -> x + y end
    cost_compare = CleverElixirAlgorithms.Utilities.cost_compare_fn objective
    random_sample = CleverElixirAlgorithms.Utilities.random_sample_fn problem_size, sample_space
